...
-- Comprehensive behavioral analysis for each address with asset-agnostic thresholds
...
-- Address Behavior Profiles View
-- Comprehensive behavioral analysis for each address with asset-agnostic histogram bins
...
SELECT
    ...
    -- Asset-agnostic transaction size histogram (client can define thresholds)
